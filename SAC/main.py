...
from QuadrupedRobotEnv import QuadrupedRobotEnv
...
parser.add_argument('--model_save_frequency', type=int, default=10000, metavar='N',
...
env = QuadrupedRobotEnv(render=False, max_episode_steps=5000)
env.seed(args.seed)
